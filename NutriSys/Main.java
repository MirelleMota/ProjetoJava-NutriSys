...
public class Main {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			System.out.println("5 - Deixar um coment·rio sobre a sua dieta");
			System.out.println("6 - Visualizar coment·rios");
			...
			if (x == 1) {
				...
				if (IMC < 18.5) {
					...
					System.out.printf("\nVocÍ est· com Obesidade grau I " + "\nSeu IMC È: %.2f \n", IMC);
				} else if (IMC >= 35 && IMC < 40) {
					System.out.printf("\nVocÍ est· com Obesidade grau II " + "\nSeu IMC È: %.2f \n", IMC);
				} else {
					System.out.printf("\nVocÍ est· com Obesidade grau III" + "\nSeu IMC È: %.2f \n", IMC);
				}
